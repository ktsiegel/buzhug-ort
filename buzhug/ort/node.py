...
class RangeLeaf(RangeNode):
    def __init__(self, data, B):
        ...
        self.values = [d[0][0] for d in data[1:]]
    ...
    def get_range_data(self, start, end):
        # Same as above: get the indices of data points bounded by the start and
        # end values. For each, we want the index of the first child whose
        # minimum value is greater than key.
