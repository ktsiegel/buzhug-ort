...
class RangeTree(object):
    # Build a tree from a list of generic objects, represented as lists of
    # tuples. Each object should have the same d keys, each one of which maps
    # to a comparable value. They should already be ordered. If they are not,
    # everything will fuck up. Don't make everything fuck up.  
